...
import ContactRequestsAdmin from "./pages/ContactRequestsAdmin";
...
import AreaLavoratori from "./pages/AreaLavoratori";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/area-lavoratori" element={<ProtectedRoute><AreaLavoratori /></ProtectedRoute>} />
          ...
          <Route path="/admin/contact-requests" element={<ProtectedRoute><ContactRequestsAdmin /></ProtectedRoute>} />
